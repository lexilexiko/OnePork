...
namespace SDLayout {
    ...
    const char* metaDir();
    const char* passworldDir();   // wordlists: /m5porkchop/Passworld
    const char* pigpassDir();     // pigpass cache: /m5porkchop/pigpass
    ...
    const char* pigpassLastWordlistPath();  // last selected dictionary
