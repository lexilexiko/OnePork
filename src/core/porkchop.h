...
enum class PorkchopMode : uint8_t {
    ...
    PIGPASS_MODE = 25,     // WiFi password cracker (brute force WPA2)
    MICPORK_MODE = 26,     // Mic spectrum dance (MicPork)
    ...
    PWNCRACK_MODE = 31,    // pwncrack.org cloud crack (separate from WPA-SEC)
