...
static constexpr const char* kNewPassworld = "/m5porkchop/Passworld";
static constexpr const char* kNewPigpass = "/m5porkchop/pigpass";
static constexpr const char* kLegacyPassworld = "/Passworld";
...
static constexpr const char* kNewPwncrackKey = "/m5porkchop/pwncrack/key.txt";
static constexpr const char* kNewPwncrackResults = "/m5porkchop/pwncrack/results.txt";
static constexpr const char* kNewPwncrackUploaded = "/m5porkchop/pwncrack/uploaded.txt";
static constexpr const char* kLegacyPwncrackResults = "/pwncrack_results.txt";
static constexpr const char* kLegacyPwncrackUploaded = "/pwncrack_uploaded.txt";
...
static constexpr const char* kNewPigpassResults = "/m5porkchop/pigpass/cracked.txt";
static constexpr const char* kLegacyPigpassResults = "/pigpass_cracked.txt";
static constexpr const char* kNewPigpassCheckpoint = "/m5porkchop/pigpass/checkpoint.txt";
static constexpr const char* kLegacyPigpassCheckpoint = "/pigpass_checkpoint.txt";
static constexpr const char* kNewPigpassLastWl = "/m5porkchop/pigpass/last_wl.txt";
static constexpr const char* kLegacyPigpassLastWl = "/pigpass_last_wl.txt";
...
const char* passworldDir() { return usingNewLayout() ? kNewPassworld : kLegacyPassworld; }
const char* pigpassDir() { return usingNewLayout() ? kNewPigpass : "/"; }
...
const char* pwncrackResultsPath() {
    return usingNewLayout() ? kNewPwncrackResults : kLegacyPwncrackResults;
}
const char* pwncrackUploadedPath() {
    return usingNewLayout() ? kNewPwncrackUploaded : kLegacyPwncrackUploaded;
}
const char* wigleKeyPath() { return usingNewLayout() ? kNewWigleKey : kLegacyWigleKey; }
const char* pigpassResultsPath() {
    return usingNewLayout() ? kNewPigpassResults : kLegacyPigpassResults;
}
const char* pigpassCheckpointPath() {
    return usingNewLayout() ? kNewPigpassCheckpoint : kLegacyPigpassCheckpoint;
}
const char* pigpassLastWordlistPath() {
    return usingNewLayout() ? kNewPigpassLastWl : kLegacyPigpassLastWl;
}
...
void ensureDirs() {
    ...
    ensureDir(kNewMeta);
    ensureDir(kNewPassworld);
    ensureDir(kNewPigpass);
}
